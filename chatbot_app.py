...
app.layout = html.Div([
    html.Div(id="div1", style={'display': 'flex', 'alignItems': 'center', 'justifyContent': 'center'}, children=[
        html.Img(src='/assets/logo.png', style={'height': '60px'}),
        html.H1("Concept.AI", style={'textAlign': 'center', 'margin': '0'})
    ]),
    html.Div(id='chatbot-output', style={'padding': '10px', 'flex': '1', 'overflowY': 'auto', 'display': 'flex', 'flexDirection': 'column-reverse'}),
    html.Div([
        dcc.Textarea(id='user-input', value='Ask something...', style={'width': '100%', 'height': 100}),
        html.Button('Submit', id='submit-button', n_clicks=0),
        html.P("This model can make mistakes.", style={'textAlign': 'center', 'margin': '10px'})
    ], style={'position': 'fixed', 'bottom': '0', 'width': '100%', 'backgroundColor': 'white', 'paddingBottom': '20px'})
])
